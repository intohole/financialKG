...
from .task_manager import TaskManager, TaskPriority, TaskExecutionInfo
...
class TaskCoordinator:
    ...
    async def add_cron_task(
        ...
        task_config = TaskConfig(
            ...
            task_trigger={"type": "cron", "expression": cron_expression, "start_date": start_date, "end_date": end_date},
            task_dependencies=[],
    ...
    async def add_interval_task(
        ...
        task_config = TaskConfig(
            ...
            task_function=func,
            task_params=task_params or {},
            task_trigger={"type": "interval", "seconds": interval, "start_date": start_date, "end_date": end_date},
            task_dependencies=[],
            task_priority=task_priority,
            task_active=task_active,
            task_description=task_description
    ...
    async def get_task_execution_info(self, task_id: str) -> Optional[TaskExecutionInfo]:
        """
        获取任务执行信息
    ...
    async def get_task_execution_history(self, task_id: str) -> Optional[List[TaskExecutionInfo]]:
        """
        获取任务执行历史
