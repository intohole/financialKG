...
"""
    ...
    def aggregate_relations_by_type(self, relations: List[Dict[str, Any]], relation_type: str) -> Dict[str, Any]:
        """
        按关系类型聚合相似关系
...
"""
    ...
    def merge_relation_attributes(self, relations: List[Dict[str, Any]]) -> Dict[str, Any]:
        """
        合并关系的属性
...
"""
    ...
    def consolidate_relations(self, relations: List[Dict[str, Any]], entities: List[Dict[str, Any]]) -> Dict[str, Any]:
        """
        整合关系，考虑实体聚合结果
