...
class DeduplicationServiceRegistry:
    ...
    @classmethod
    def get_service(cls, service_id: str = _default_service_id) -> Optional[EntityRelationDeduplicationService]:
        """
        获取去重服务实例
...
def create_deduplication_service_provider(
    ...
    # 使用配置（如果提供）
    service_id = service_config.get("service_id", "default") if service_config else "default"
