...
def validate_embedding(embedding: List[float], expected_dimension: Optional[int] = None) -> bool:
    """
    验证嵌入向量的有效性
...
def aggregate_embeddings(embeddings: List[List[float]], method: str = "mean") -> List[float]:
    """
    聚合多个嵌入向量
